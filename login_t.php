<!DOCTYPE html>
  <head>
    <title>Teacher Login | sourceX</title>
    <meta charset="utf-8">
    ...
    <style>
    .leftbox {
      background: url("resources/logint.jpg");
      background-size: cover;
      background-repeat:  no-repeat;
    }

    #submit {
      background: linear-gradient(to right,#5ac2e8,#2585a8 );
    ...
    <div class="basebox">
      <span class="leftbox">
        ...
        <div class="leftboxtext">
          ...
          <button class="reg"><a href="register_t.php">REGISTER HERE</a></button>
        </div>
      </span>
      <span class="rightbox">
        ...
        <form action="" method="post">
          ...
          <span class="floating-label one">Teacher ID</span>
